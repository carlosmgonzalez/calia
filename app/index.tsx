  ...
  const NutrientCard = ({
    ...
    <View className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
      ...
      <Text className={`text-2xl font-bold ${color}`}>
        {value}
        {unit && <Text className="text-base text-gray-500">{unit}</Text>}
      </Text>
    </View>
  );
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text className="text-gray-600 text-base">
            Analiza tu comida y obtén información nutricional detallada
          </Text>
        </Animated.View>
            ...
            {selectedImage ? (
              <View className="items-center">
                ...
                <TouchableOpacity
                  ...
                  className={`${
                    isAnalyzing ? "bg-gray-300" : "bg-primary-500"
              ...
              >
                ...
                <Text className="text-gray-600 text-center">
                  Toca aquí para seleccionar una foto de tu comida desde la
                  galería
                </Text>
              </TouchableOpacity>
            )}
          ...
          >
            ...
            <View className="bg-white rounded-3xl p-6 mb-4 shadow-sm border border-gray-100">
              ...
              <View className="flex-row justify-between bg-gray-50 rounded-xl p-3">
                <View>
                  <Text className="text-gray-600 text-sm">Porción</Text>
                  <Text className="font-bold text-gray-900">
                    {nutritionData.foodAnalysis.portionSize}gr
                  </Text>
                </View>
                <View>
                  <Text className="text-gray-600 text-sm">Ración</Text>
                  <Text className="font-bold text-gray-900">
                    {nutritionData.foodAnalysis.recognizedServingSize}gr
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className="bg-white rounded-3xl p-6 mb-4 shadow-sm border border-gray-100">
              ...
              <View className="bg-emerald-400 rounded-2xl p-4 mb-4">
                ...
                <Text className="text-black text-4xl font-bold">
                  {nutritionData.foodAnalysis.nutritionFactsPerPortion.calories}
              ...
              <View className="flex-row flex-wrap justify-between gap-3">
                <View className="w-[48%]">
                  <NutrientCard
                    label="Proteínas"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPerPortion
                        .protein
                    }
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Carbohidratos"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPerPortion.carbs
                    }
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Grasas"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPerPortion.fat
                    }
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Fibra"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPerPortion.fiber
                    }
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Azúcar"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPerPortion.sugar
                    }
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Sodio"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPerPortion.sodium
                    }
                    color="text-gray-600"
                    unit="mg"
                  />
              ...
              <View className="flex-row flex-wrap justify-between gap-3">
                <View className="w-[48%]">
                  <NutrientCard
                    label="Cal"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPer100g.calories
                    }
                    color="text-primary-600"
                    unit="kcal"
                  />
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Prot"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPer100g.protein
                    }
                    color="text-success-600"
                    unit="gr"
                  />
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Carb"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPer100g.carbs
                    }
                    color="text-warning-600"
                    unit="gr"
                  />
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Grasa"
                    value={nutritionData.foodAnalysis.nutritionFactsPer100g.fat}
                    color="text-error-600"
                    unit="gr"
                  />
                </View>
                <View className="w-[48%]">
                  <NutrientCard
                    label="Fibra"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPer100g.fiber
                    }
                    color="text-primary-600"
                    unit="gr"
                  />
                ...
                <View className="w-[48%]">
                  <NutrientCard
                    label="Sodio"
                    value={
                      nutritionData.foodAnalysis.nutritionFactsPer100g.sodium
                    }
                    color="text-gray-600"
                    unit="mg"
                  />
            ...
            <View className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
              ...
              {nutritionData.foodAnalysis.additionalNotes.map((note, index) => (
